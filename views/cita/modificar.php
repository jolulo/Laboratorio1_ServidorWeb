            ...
            <form action="../../controllers/CitaController.php?accionc=editar&id=<?php echo $cita->id;?>" method="post">
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="servicio" class="form-control" value="<?php echo $cita->tipo_servicio;?>" required />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-12">
                            <label>Motivo</label>
                            <input type="text" name="motivo" class="form-control" value="<?php echo $cita->motivo;?>" required  />
                        </div>
                    </div>
                </div>
                <div class="form-group">
